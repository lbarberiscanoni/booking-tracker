...
var getInfo = function(a) {
    ...
    guestList.on("child_added", function(snapshot) {
        ...
        if (personName == guestSearched) {
            ...
            $("#message").html("<h2 class='text-center'>" + guestSearched + "</h2><div class='col-md-4'></div><div class='col-md-4'><table class='table table-bordered'><tr><td>Location</td><td id='location'>" + person.location + "</td><tr><td>Start</td><td id='start'>" + person.start + "</td></tr><tr><td>End</td><td id='end'>" + person.end + "</td></tr><tr><td>Status</td><td id='status'>" + person.status + "</td></tr></table></div><div class='col-md-4'></div>");
        };
    });
};
